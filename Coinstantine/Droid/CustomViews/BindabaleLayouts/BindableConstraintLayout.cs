...
{
    public class BindableConstraintLayout : Android.Support.Constraints.ConstraintLayout, IDataContextProvider, IMvxBindingContextOwner
    {
        private readonly int _templateId;
        private readonly IMvxAndroidBindingContext _bindingContext;

        public BindableConstraintLayout(Context context, IAttributeSet attrs)
            : this(MvxAttributeHelpers.ReadTemplateId(context, attrs), context, attrs)
        {
        }

        public BindableConstraintLayout(int templateId, Context context, IAttributeSet attrs)
            : base(context, attrs)
        {
        ...
        protected BindableConstraintLayout(IntPtr javaReference, JniHandleOwnership transfer)
            : base(javaReference, transfer)
        {
        }

        public BindableConstraintLayout(Context context) : base(context)
        {
            _bindingContext = new MvxAndroidBindingContext(context, (IMvxLayoutInflaterHolder)context);
        }
        ...
        public object DataContext
        {
            ...
            set
            {
                if (_isAttachedToWindow && value != null)
                {
                ...
                else
                {
                    ...
                    if (_bindingContext?.DataContext != null && value != null)
                    {
