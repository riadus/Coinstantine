    ...
    public static class AndroidViewExtensions
    {
        ...
        public static void SetControl(this AppCompatImageButton imageView, ImageButtonControl control)
        {
            ...
            if (control.Image != null)
                imageView.SetImageDrawable(GetImage(control.Image, control.TintColor));
        ...
        public static void SetControl(this ImageView imageView, ImageControl control)
        {
            ...
            if (control.Image != null)
                imageView.SetImageDrawable(GetImage(control.Image, null));
        }
        ...
        private static ShapeDrawable createRoundedIndicator(SplatColor color)
        {
        ...
        private static Drawable GetImage(string resource, SplatColor? color)
        {
            var image = BitmapLoader.Current.LoadFromResource(resource, null, null).Result.ToNative();

            if(color != null)
            {
                image.SetColorFilter(color.Value.ToNative(), PorterDuff.Mode.SrcIn);
            }
