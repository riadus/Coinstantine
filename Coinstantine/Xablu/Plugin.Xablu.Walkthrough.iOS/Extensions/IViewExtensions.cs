...
namespace Plugin.Xablu.Walkthrough.Extensions
{
    public static class IViewExtensions
    {
        ...
        public static async Task SetControl(this UIKit.UIImageView imageView, ImageControl control)
        {
            ...
            imageView.Image = await GetImage(control.Image, false);
        }
        ...
        public static async Task SetControl(this UIKit.UIButton button, ImageButtonControl control, bool handleTouchUpInside = true)
        {
            ...
            button.SetImage(await GetImage(control.Image, control.TintColor != null), UIControlState.Normal);
            if (control.TintColor != null)
            {
                button.TintColor = control.TintColor.ToNative();
            }
        ...
        private static async Task<UIImage> GetImage(string imageRes, bool withTintCapability)
        {
