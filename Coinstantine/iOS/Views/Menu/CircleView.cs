...
namespace Coinstantine.iOS.Views.Menu
{
    public class CircleView : UIView
    {
        ...
        public CircleView(nfloat radius, float timingOffset)
        {
            _radius = radius;
        ...
        private void DrawCross(UIView parent)
        {
            var shapeLayer = new CAShapeLayer
            {
                ...
                CornerRadius = 5,
                StrokeColor = AppColorDefinition.SecondaryColor.ToCGColor(),
                FillColor = AppColorDefinition.SecondaryColor.ToCGColor(),
                LineWidth = 3,
            };
